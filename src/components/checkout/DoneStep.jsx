...
// Delivery details are locked the moment the order is placed (the server
// rejects every status, including pending_payment), so there is deliberately
// no Edit button here — only this note.
